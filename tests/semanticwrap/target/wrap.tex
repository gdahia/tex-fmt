...
% This comment is very long so needs to be split over three lines
% which is another edge case which should be checked here with all
% these extra words

% double break after only comment
% This line is all a long comment.
%  This comment is very long so needs to be split over three lines
% which is another edge case which should be checked here with all
% these extra words
...
(This line is too long because it has more than eighty characters inside it.
  Therefore it should be split.
  It also needs splitting onto multiple lines, and the middle lines
should be indented due to these brackets.)

% long lines with double brackets
((This line is too long because it has more than eighty characters inside it.
    Therefore it should be split.
    It also needs splitting onto multiple lines, and the middle lines
should be doubly indented due to these brackets.))
