...
% be split over three lines which is another edge case which should be
% checked here with all these extra words

% double break after only comment
% This line is all a long comment. This comment is very long so needs
% to be split over three lines which is another edge case which should
